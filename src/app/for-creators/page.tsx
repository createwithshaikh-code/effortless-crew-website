...
export const metadata: Metadata = {
  title: "Video Editing, YouTube Automation & Growth for Creators | Effortless Crew",
  description: "Stop doing it all by yourself. We edit your videos, automate your faceless YouTube, and many more — so you can focus on creating.",
};

const PAIN_POINTS = [
  { q: "Behind on uploads?", a: "We keep your schedule consistent — no more missed weeks or burnt-out editing sessions." },
  { q: "Channel not growing?", a: "We optimize every video for the algorithm, your niche, and your audience to push the numbers up." },
  { q: "Editing taking too long?", a: "Fast turnaround. Professional quality. Every single time, without you lifting a finger." },
];

const SERVICES = [
  { n: "01", name: "Video Editing", desc: "High-retention edits that keep viewers watching till the end" },
  { n: "02", name: "YouTube Automation", desc: "Full faceless channels built, scripted, and run for you" },
  { n: "03", name: "Short Form Content", desc: "Viral Reels, Shorts, and TikToks that actually perform" },
  { n: "04", name: "Thumbnail Design", desc: "Click-worthy visuals engineered for maximum CTR" },
  { n: "05", name: "Traffic & Growth", desc: "Organic discovery strategies that compound over time" },
  { n: "06", name: "Channel Strategy", desc: "Data-driven roadmaps built for long-term sustainable growth" },
];
  ...
  return (
    <>
      <style>{`
        ...
        .pp-card {
          padding:44px 36px;background:rgba(255,80,0,.015);
        ...
        /* SERVICES */
        .sv {
          position:relative;z-index:1;padding:60px 8% 80px;
        }
        .sv-grid {
        ...
        .sv-card {
          padding:36px 30px;background:rgba(0,0,0,.5);
          transition:background .3s;
        }
      ...
      <div className="pg">
        ...
        <section className="ph">
          <div className="ph-inner">
            <span className="ph-eyebrow">For Creators</span>
            <h1 className="ph-headline">Built For<br />Creators</h1>
            <p className="ph-sub">Stop doing it all. Focus on the content.</p>
            <Link href="mailto:createwithshaikh@gmail.com" className="pg-cta">
              <span className="fill" /><span>Let&apos;s Grow Your Channel →</span>
            </Link>
          </div>
          <div className="ph-horizon">
            <svg viewBox="0 0 1440 400" preserveAspectRatio="xMidYMax slice" style={{width:"100%",height:"100%",overflow:"visible"}} xmlns="http://www.w3.org/2000/svg">
              <defs>
                <linearGradient id="crPG" x1="0" y1="0" x2="0" y2="1">
                ...
                <linearGradient id="crAG" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" stopColor="#ff8c00" stopOpacity="0"/>
                  <stop offset="50%" stopColor="#ff8c00" stopOpacity="0.35"/>
                  <stop offset="100%" stopColor="#ff8c00" stopOpacity="0"/>
                </linearGradient>
                <filter id="crGlow" x="-20%" y="-200%" width="140%" height="500%">
                  <feGaussianBlur stdDeviation="4" result="blur"/>
                  <feMerge><feMergeNode in="blur"/><feMergeNode in="SourceGraphic"/></feMerge>
                </filter>
                <filter id="crAGlow" x="-5%" y="-300%" width="110%" height="700%">
                  <feGaussianBlur stdDeviation="10"/>
                </filter>
              </defs>
              <path d="M-100,120 Q720,-60 1540,120 L1540,500 L-100,500 Z" fill="url(#crPG)"/>
              <path d="M-100,120 Q720,-60 1540,120 L1540,80 Q720,-100 -100,80 Z" fill="url(#crAG)" filter="url(#crAGlow)" opacity="0.9"/>
              <path d="M-100,120 Q720,-60 1540,120" fill="none" stroke="rgba(255,140,0,0.9)" strokeWidth="2.5" filter="url(#crGlow)"/>
              <path d="M-100,120 Q720,-60 1540,120" fill="none" stroke="rgba(255,120,0,0.25)" strokeWidth="18" filter="url(#crAGlow)"/>
            </svg>
          </div>
        </section>
        ...
        <section className="sv">
          <p className="sec-label">What We Do For You</p>
        ...
        <section className="bc">
          <h2 className="bc-headline">Ready to Grow?</h2>
          <p className="bc-sub">Let us handle the production. You own the audience.</p>
          <Link href="mailto:createwithshaikh@gmail.com" className="pg-cta">
            <span className="fill" /><span>Start Today →</span>
          </Link>
        </section>
